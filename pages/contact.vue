...
const externalLinks = [
  { label: 'Resume', desc: 'View / Download PDF', icon: 'download', href: 'https://drive.google.com/file/d/1AGrrc0bRow8DGKcmTpyTLhmWPcrLSh0e/view?usp=share_link', download: false },
